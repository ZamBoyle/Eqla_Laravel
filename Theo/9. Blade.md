...
- [6. Les modèles](#6-les-modèles)
  - [6.1 Modèles avec héritage](#61-modèles-avec-héritage)
    - [6.1.1 Différences entre Yield et Section](#611-différences-entre-yield-et-section)
    - [6.1.2 Yield](#612-yield)
    - [6.1.3 Section](#613-section)
  - [6.2 Modèles avec Component](#62-modèles-avec-component)
  - [6.2.1 Migration d'un site existant](#621-migration-dun-site-existant)
...
@stop
```
#### 6.1.1 Différences entre Yield et Section
...
### 6.2.1 Migration d'un site existant
