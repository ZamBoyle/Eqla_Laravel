...
- [6. Les modèles / Mises en page](#6-les-modèles--mises-en-page)
- [7. modèles avec héritage](#7-modèles-avec-héritage)
  - [7.1 Différences entre Yield et Section](#71-différences-entre-yield-et-section)
  - [7.2 Yield](#72-yield)
  - [7.3 Section](#73-section)
- [8. Modèles avec Component](#8-modèles-avec-component)
...
Soit vous créez ce fichier modele.blade.php à la main ou bien via php artisan avec la commande
```php
...
La variable $slot sera remplie par tout ce qui sera affiché en dehors des \<x-slot>.
