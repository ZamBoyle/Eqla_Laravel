...
URL: localhost:8000/users/List<br/>Résultat: 
```php
Résultat
- Nom: Piette
- Prénom: Johnny
...
URL: localhost:8000/users/SearchByName/Piette<br/>Résultat: 
```php
Résultat
- Nom: Piette
- Prénom: Johnny
...
URL: localhost:8000/users/SearchByFirstname/Jacques<br/>Résultat:
```php
Résultat
- Nom: Larock
- Prénom: Jacques
...
URL: localhost:8000/users/Search/Jacques<br/>Résultat:
```php
- Nom: Jacques
- Prénom: Véronique
- Nom: Larock
