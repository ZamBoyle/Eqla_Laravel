...
## 13. Récupérer les paramètres de la requête
...
### 13.1 Via l'url par la méthode query() de la classe Request
...
### 13.2 Via la méthode input() de la classe Request
...
### 13.3 Via la méthode all() de la classe Request
La méthode all() permet de récupérer un tableau associatif de paramètres.
```php
use Illuminate\Http\Request;
...
### 13.4 Via la méthode only() de la classe Request
La méthode only() permet de récupérer un tableau associatif de paramètres.
```php
use Illuminate\Http\Request;
