...
```php
User::where('name','<>','Pietta ')->where('email','like','%gmail.com')->get();
```

Afficher les utilisateurs dont le nom est 'Pietta' ou 'Jacques'. Pour le 'or' on va chaîner avec un orWhere:
```php
User::where('name','Pietta ')->orWhere('name','Jacques')->get();
```
...
2024_05_08_063246_add_arrete_to_tutus ............................................................................................... 61.83ms DONE
```
