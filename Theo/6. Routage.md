...
- [3. Routage retournant une vue (view)](#3-routage-retournant-une-vue-view)
...
- [8. Routage retournant sur tableau json](#8-routage-retournant-sur-tableau-json)
- [9. Routage retournant une vue via un contrôleur](#9-routage-retournant-une-vue-via-un-contrôleur)
- [10. Nommage d'une route](#10-nommage-dune-route)
- [11. Liste des routes via php artisan](#11-liste-des-routes-via-php-artisan)
...
## 3. Routage retournant une vue (view)
...
{
    if($allee) return "Le numéro de l'article est $numero et il est rangé dans l'allée n°$allee.";
...
## 8. Routage retournant sur tableau json

## 9. Routage retournant une vue via un contrôleur
...
## 11. Liste des routes via php artisan
