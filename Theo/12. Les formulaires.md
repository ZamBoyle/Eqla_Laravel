...
Donc, si vous grand hacker vous mettez @csrf dans votre formulaire d'attaque, le serveur interprêtera cela comme du texte... En effet, @csrf est interprêté côté serveur et n'est jamais affiché dans un formulaire côté client. En fait, Laravel quand il "voit" @csrf va générer une balise de formulaire ressemblant à \<input type="hidden" name="_token" value="7GqWidw0PLOFbLjeC3nJmGswYWZGpWaCuSCKHbyJ"\>
