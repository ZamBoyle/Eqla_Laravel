...
Mais afin  de ne pas rompre la compatibilité d'anciens scripts, on ne force pas le typage par défaut. Mais si on veut vraiment avoir un typage fort, il faut utiliser en haut de nos fichiers PHP: 
```php
