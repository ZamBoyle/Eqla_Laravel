...
- [1. Le typage en PHP 7](#1-le-typage-en-php-7)
  ...
  - [1.5 L'opérateur Null coalescent](#15-lopérateur-null-coalescent)
- [2. Fonctions anonymes](#2-fonctions-anonymes)
  - [Exemple 1: Auto-invoquer une fonction anonyme](#exemple-1-auto-invoquer-une-fonction-anonyme)
  - [Exemple 2: Utiliser une fonction anonyme comme paramètre d'une fonction.](#exemple-2-utiliser-une-fonction-anonyme-comme-paramètre-dune-fonction)
  - [Exemple 3: Affectation d'une fonction anonyme dans une variable.](#exemple-3-affectation-dune-fonction-anonyme-dans-une-variable)
  - [Exemple 4: Passage d'une variable d'une autre portée (scope) à une fonction anonyme](#exemple-4-passage-dune-variable-dune-autre-portée-scope-à-une-fonction-anonyme)
  - [Exemple 5: Un peu de tout :)](#exemple-5-un-peu-de-tout-)
- [3. La programmation orientée object (POO)](#3-la-programmation-orientée-object-poo)
  ...
  - [3.4 Opérateurs de résolution de portée](#34-opérateurs-de-résolution-de-portée)
...
### 1.5 L'opérateur Null coalescent
...
```
Le mieux serait d'utiliser l'opérateur Null coalescent qui s'écrit ??
```php
public function hasChild(): bool
{
...
### Exemple 2: Utiliser une fonction anonyme comme paramètre d'une fonction.
```php
...
### Exemple 4: Passage d'une variable d'une autre portée (scope) à une fonction anonyme
...
### 3.4 Opérateurs de résolution de portée
