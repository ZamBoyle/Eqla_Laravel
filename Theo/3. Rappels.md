...
- [1. Fonctions anonymes](#1-fonctions-anonymes)
  - [1.1 Auto-invoquer une fonction anonyme](#11-auto-invoquer-une-fonction-anonyme)
  - [1.2 Utiliser une fonction anonyme comme paramètre d'une fonction.](#12-utiliser-une-fonction-anonyme-comme-paramètre-dune-fonction)
  - [1.3: Affectation d'une fonction anonyme dans une variable.](#13-affectation-dune-fonction-anonyme-dans-une-variable)
  - [1.4: Passage d'une variable d'une autre portée (scope) à une fonction anonyme](#14-passage-dune-variable-dune-autre-portée-scope-à-une-fonction-anonyme)
  - [1.5: Un peu de tout :)](#15-un-peu-de-tout-)
- [2. La programmation orientée object (POO)](#2-la-programmation-orientée-object-poo)
  ...
  - [2.3 Héritage](#23-héritage)
  - [2.4 Opérateurs de résolution de portée](#24-opérateurs-de-résolution-de-portée)
- [1. Le typage en PHP 7](#1-le-typage-en-php-7)
  - [1.1 Typer le paramètre d'une fonction](#11-typer-le-paramètre-dune-fonction)
  - [1.2 Typer la valeur de retour d'une fonction](#12-typer-la-valeur-de-retour-dune-fonction)
  - [1.3 Fonction sans retour de valeur (void)](#13-fonction-sans-retour-de-valeur-void)
  - [1.4 Typer les attributs d'une classe](#14-typer-les-attributs-dune-classe)
...
### 1.1 Auto-invoquer une fonction anonyme
```php
(function(){
...
### 1.2 Utiliser une fonction anonyme comme paramètre d'une fonction.
```php
...
### 1.3: Affectation d'une fonction anonyme dans une variable.
```php
...
### 1.4: Passage d'une variable d'une autre portée (scope) à une fonction anonyme
...
### 2.4 Opérateurs de résolution de portée
...
### 1.1 Typer le paramètre d'une fonction
...
### 1.2 Typer la valeur de retour d'une fonction
...
### 1.3 Fonction sans retour de valeur (void)
...
### 1.4 Typer les attributs d'une classe
