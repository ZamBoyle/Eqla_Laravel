...
Alors pour l'écriture des membres privés d'une classe (méthodes/attributs), certains ont pris la convention d'écrire tout membre public avec un underscore. 
```php
public string $nom;
private bool $_contientLait;
```
