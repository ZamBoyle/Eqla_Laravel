...
- [1. Fonctions anonymes](#1-fonctions-anonymes)
  ...
  - [Exemple 4: Passage d'une variable d'une autre portée(scope) à une fonction anonymé](#exemple-4-passage-dune-variable-dune-autre-portéescope-à-une-fonction-anonymé)
