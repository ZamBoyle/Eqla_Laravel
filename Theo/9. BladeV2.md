...
----- Début de code PHP -----
```php<p>L'article n°<?php echo $numero ?> se trouve dans l'allée <?php echo $allee ?></p>
```
----- Fin de code PHP -----
...
----- Début de code PHP -----
```php<h1>Attaquons ces vampires ! </h1>
...
----- Début de code PHP -----
```phpRoute::get('/page{numero}', function ($numero) {
...
----- Début de code PHP -----
```phpphp artisan make:component modele
```
----- Fin de code PHP -----
